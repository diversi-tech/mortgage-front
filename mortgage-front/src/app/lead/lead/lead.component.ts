...
if (localStorage.getItem('isAddDocuments') !== 'true'){
             this.getDocumentsByTransactionTypeAndAdd();
  ...
  getDocumentsByTransactionTypeAndAdd(): void {
