...
export class LoginComponent {
  ...
  constructor(private route: ActivatedRoute, private leadService: leadService, private fb: FormBuilder, private _auth: AuthService, private snackBar: MatSnackBar, private router: Router, private userService: UserService) {
